...
public  abstract class Function extends Methode {
    ...
    public Function(Memory memory,int nbRepetition,String chaine){
        super(memory,nbRepetition,chaine);
    }


    public Function(Memory memory,Procedure procedure,int pointeurMémoire){
        super(memory,procedure,pointeurMémoire);
    }
