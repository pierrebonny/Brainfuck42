...
public class Check {
    ...
    //Méthode Check est la SEULE méthode qui va lire le fichier (texte ou image), STOCKER les instructions dans la liste Programm de Instruction, vérifier le parenthésage et remplir la jumpBackMap
